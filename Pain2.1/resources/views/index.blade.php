...
<html lang="ru">
  ...
  <body class="vh-100 bg-CustomDark">
        ...
        <div class="col">
          ...
          >
            <div class="col-4 col-md-4">
              <img
                src="/img/feature-{{$roadmap->id}}.svg"
            ...
            >
              <div class="d-flex flex-row headlines">
                <h4 class="text-CustomPrimary me-2">0{{$roadmap->id}}</h4>
    ...
    <section class="my-md-5" id="example">
      <div class="my-5 pt-5">
        <h5 class="text-CustomPrimary text-center">Популярные заказы</h5>
        <h1 class="text-CustomWhite text-center headlines mx-5 px-3">
          Популярные мобильные продукты
        </h1>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card bg-CustomBrown border-0">
              <img src="/img/popular-{{$popular->id}}.jpg" class="card-img-center m-4 float-center rounded-2" alt="" />
              <div class="card-body text-CustomWhite">
                ...
                <h6 class="text-uppercase">Цена - <strong class="text-CustomPrimary">${{$popular->discount}}/</strong>${{$popular->price}}</h6>
                <button
    ...
    <!-- Section Custom Order Start -->
    <section class="my-5 pt-md-4" id="CustomOrder">
      <div class="bg-CustomBrown">
        <div class="container CustomWidth pb-4">
          <div class="row">
            <div class="col-10 col-md-6 py-0 px-0 mx-auto mx-md-0">
              <div class="card border-0 pt-4 bg-CustomBrown">
                <img
            ...
            <div class="col-md-6 py-3 py-md-4 px-3 px-md-5 my-md-auto text-CustomWhite">
              <div class="row">
                <h5 class="text-CustomPrimary text-center">Собственный заказ</h5>
                <h1 class="headlines text-center mb-md-4">Индивидуальный проект</h1>
              </div>
              ...
              <div class="row">
                  <form action="/post" method="POST">
                    ...
                    <textarea
                      ...
                      rows="5"
                      name="text"
                      placeholder="Тема проекта и детали"
                      required
                    ></textarea>
                    <div class="container mt-3 mt-md-5 d-flex aligh-items-center justify-content-center">
                      <input type="submit" value="Оставить заявку" class="submit btn btn-CustomPrimary text-CustomWhite text-nowrap headlines fs-6 px-4 rounded-4" required />
                    </div>
                  </form>
              </div>
      ...
      >
        ...
        <div class="col mb-3">
          ...
          >
            ...
            >
              <h5 class="card-title col-12 col-md-8 px-0 headlines">{{$types->title}}</h5>
